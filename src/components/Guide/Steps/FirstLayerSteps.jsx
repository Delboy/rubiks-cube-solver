...
export let firstLayerSteps = [
  [
    <div key="1" className={classes.container}>
      ...
      <p>We now have to solve the corners on the bottom layer!</p>
      <p>
        There are three case scenarios to look for when solving the first layers
        corners.
      </p>
  ...
  [
    <div className={classes.container} key={"2"}>
      <p>
        The first case scenario is when a corner piece in the top row has an
        outward facing white edge
      </p>
      <p>
        Once you have located a corner like this, line up its opposite edge (not
        the one not facing upwards) to the center piece of the same color
      </p>
      <p>like so...</p>
  ...
  [
    <div className={classes.container} key="3">
      <p>You now have to perform an algorithm to solve the piece</p>
      <p>
      ...
      <p>L' U' L</p>
      <p>
        Once the algorithm has been completed the corner will have moved from
        the top row to the bottom, solving that part of the layer!
      </p>
      <div className={classes.perspectiveScene} style={{ margin: "2rem 0" }}>
        <div className={`${classes.cube} ${classes.bottomAndSideView}`}>
          <div
  ...
  [
    <div className={classes.container} key="4">
      <p>The second scenario is if a corner piece is in the bottom row</p>
      <p>like this...</p>
      <div className={classes.perspectiveScene} style={{ margin: "2rem 0" }}>
        <div className={`${classes.cube} ${classes.topAndSideView}`}>
          <div
      ...
      <p>
        Face the same side as the corners colored edge and perform the same
        algorithm as before
      </p>
  ...
  [
    <div className={classes.container} key="5">
      <p>
        The last case scenario is when a corner piece is in the top row with the
        white face facing upwards!
      </p>
      <p>Like this...</p>
      <div className={classes.perspectiveScene} style={{ margin: "2rem 0" }}>
        <div className={`${classes.cube} ${classes.topAndSideView}`}>
      ...
      <p>
        To solve this piece, rotate the top so that the corner piece is above
        the bottom corner where you want it to go, like in the example above
      </p>
      <p>
      ...
      <p>
        ...
        face outwards. From here you can solve the corner using the steps for
        the first scenario!
      </p>
    </div>,
  ],
  [
    <div className={classes.container} key="6">
      <p>
        Once you have done this for all four corner pieces you have solved the
        first layer!
      </p>
      <p>
        Try closing the guide and achieving this alone or press next to continue
        the guide of what to do
      </p>
    </div>,
  ],
];
